...
During benchmark you must use *performance* mode for your CPU. To setup your *cpu governance mode* I process as follow.
...
#+ATTR_WP: :syntaxhl light=true
#+BEGIN_SRC cmake :tangle yes :tangle ./code/cmake/ConfigSafeGuards.cmake :mkdirp yes :tangle-mode (identity #o666) :noweb yes :export none  
...
#+ATTR_WP: :syntaxhl light=true
#+BEGIN_SRC cmake :tangle yes :tangle ./code/cmake/DownloadProject.cmake :mkdirp yes :tangle-mode (identity #o666) :noweb yes :export none
...
#+ATTR_WP: :syntaxhl light=true
#+BEGIN_SRC cmake :tangle yes :tangle ./code/cmake/DownloadProject.CMakeLists.cmake.in :mkdirp yes :tangle-mode (identity #o666) :noweb yes :export none
